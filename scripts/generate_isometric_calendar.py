...
def render_svg(
  ...
  <style>
    ...
    .rule {{ stroke: #d0d7de; }}
    .level-0-top {{ fill: #ebedf0; stroke: rgba(27, 31, 35, .06); stroke-width: .55; }}
    .level-1-top, .level-1-left, .level-1-right {{ fill: #9be9a8; }}
    .level-2-top, .level-2-left, .level-2-right {{ fill: #40c463; }}
    .level-3-top, .level-3-left, .level-3-right {{ fill: #30a14e; }}
    .level-4-top, .level-4-left, .level-4-right {{ fill: #216e39; }}
    .level-1-left, .level-2-left, .level-3-left, .level-4-left {{ filter: url(#brightness-60); }}
    .level-1-right, .level-2-right, .level-3-right, .level-4-right {{ filter: url(#brightness-20); }}
